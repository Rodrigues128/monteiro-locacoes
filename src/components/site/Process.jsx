import { CalendarDays, CheckCircle2, PartyPopper, Truck } from "lucide-react";
...
const steps = [
  {
    ...
    text: "Escolha as atrações e informe a data do seu evento pelo WhatsApp.",
  },
  {
    icon: CheckCircle2,
    n: "02",
    title: "Receba o Orçamento",
    text: "Enviamos um orçamento personalizado com valores e disponibilidade.",
  },
  {
    icon: Truck,
    n: "03",
    title: "Confirme a Reserva",
    text: "Faça a reserva e escolha o horário de entrega e retirada.",
  },
  {
    icon: PartyPopper,
    n: "04",
    title: "Divirta-se!",
    text: "Receba os equipamentos montados e aproveite sua festa.",
  },
];
export default function Process() {
  return (
    <section id="como-funciona" className="bg-white px-5 py-24 lg:px-8">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {steps.map(({ icon: Icon, ...s }) => (
            ...
            >
              ...
              <Icon className="mt-4 text-[#00BFFF]" size={32} />
