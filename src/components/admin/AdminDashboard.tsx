  ...
  return (
    <section className="mt-8">
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <article className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm"><Users size={21} className="text-violet-500" /><p className="mt-5 text-sm font-bold text-slate-500">Clientes atendidos</p><p className="mt-1 text-4xl font-black">{customers.size}</p><button onClick={() => setTab("products")} className="mt-4 inline-flex items-center gap-1 text-xs font-bold text-[#008fc0] hover:underline">Gerenciar catálogo <ArrowUpRight size={13} /></button></article>
      </div>
